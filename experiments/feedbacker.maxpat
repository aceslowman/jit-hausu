...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 15.0, 480.0, 165.0, 285.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.0, 780.0, 345.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 975.0, 405.0, 345.0, 60.0 ],
					"varname" : "hausu_blur",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 975.0, 330.0, 345.0, 60.0 ],
					"varname" : "sharpen",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 705.0, 120.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "r draw"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1095.0, 900.0, 95.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 780.0, 60.0, 75.0, 75.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 1095.0, 555.0, 240.0, 330.0 ],
					"varname" : "node",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 840.0, 210.0, 109.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 709.0, 300.0, 190.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix vid-ctx 4 char 1920 1080"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 710.0, 345.0, 240.0, 165.0 ],
					"varname" : "feedback",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 45.0, 15.0, 630.0, 450.0 ],
					"varname" : "rendering",
					"viewvisibility" : 1
				}
